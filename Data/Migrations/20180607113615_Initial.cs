        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrandThumbnail = table.Column<string>(nullable: true),
                    HqCity = table.Column<string>(nullable: true),
                    HqStreet = table.Column<string>(nullable: true),
                    HqBuilding = table.Column<string>(nullable: true),
                    HqPostalCode = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cards_Employers_EmployerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployerId = table.Column<int>(nullable: false),
                    PosNeeded = table.Column<int>(nullable: false),
                    Description = table.Column<string>(nullable: true),
                    Requirments = table.Column<string>(nullable: true),
                    StartDate = table.Column<DateTime>(nullable: false),
                    EndDate = table.Column<DateTime>(nullable: false),
                    Duration = table.Column<int>(nullable: false),
                    Payrate = table.Column<int>(nullable: false),
                    ChargeRate = table.Column<float>(nullable: false),
                    TotalCharge = table.Column<float>(nullable: false),
